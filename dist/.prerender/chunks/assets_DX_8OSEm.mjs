import { h as VALID_SUPPORTED_FORMATS, m as DEFAULT_OUTPUT_FORMAT, p as DEFAULT_HASH_PROPS } from "./Layout_HkwJUfDp.mjs";
import { $ as UnsupportedImageConversion, E as LocalImageUsedWrongly, F as NoImageMetadata, T as InvalidImageService, U as RemoteImageNotAllowed, d as ExpectedNotESMImage, et as UnsupportedImageFormat, f as FailedToFetchRemoteImageDimensions, j as MissingImageDimension, l as ExpectedImage, lt as isRemotePath, mt as removeQueryString, t as AstroError, u as ExpectedImageOptions, ut as joinPaths, x as IncompatibleDescriptorOptions } from "./errors_BbSXLTaS.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_88qlcB4a.mjs").catch((e) => {
