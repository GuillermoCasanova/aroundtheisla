import { g as VALID_SUPPORTED_FORMATS, h as DEFAULT_OUTPUT_FORMAT, m as DEFAULT_HASH_PROPS } from "./Layout_Dlmeugkd.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_C8gSzbFZ.mjs").catch((e) => {
