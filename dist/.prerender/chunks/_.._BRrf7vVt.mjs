import { _ as __exportAll, a as pageSections, c as $$Footer, f as $$Button, i as getPublishedPages, l as $$Seo, n as getFooterCopyright, o as $$SmoothScroll, s as $$PageTransition, t as $$Layout } from "./Layout_Dlmeugkd.mjs";
import { C as addAttribute, F as createComponent, M as unescapeHTML, P as createAstro, S as renderHead, _ as renderTemplate, l as renderComponent, m as renderSlot, o as renderScript, r as spreadAttributes, x as maybeRenderHead } from "./server_CAElGhNO.mjs";
...
import { r as webPageSchema } from "./schema_DPp_KL_g.mjs";
...
var $$SectionWork = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<section id="work-gallery" data-work-gallery data-view="grid" aria-label="Work projects"${addAttribute(["relative bg-canvas text-fg section-pt-sm", className], "class:list")} data-astro-cid-spshn2s5> <header data-work-chrome data-astro-cid-spshn2s5> <h1 data-work-title class="h1 font-bold lowercase text-fg" data-astro-cid-spshn2s5>work</h1> <div class="flex items-center gap-4 md:flex-col md:items-start md:gap-2" role="tablist" aria-label="Gallery view" data-astro-cid-spshn2s5> <button type="button" role="tab" id="work-view-grid" data-work-view="grid" aria-controls="work-panel-grid" aria-selected="true" tabindex="0"${addAttribute([tabClass, "font-bold"], "class:list")} data-astro-cid-spshn2s5>
Grid
